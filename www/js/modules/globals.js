...
Globals.factory("Global",function(){
	obj = {
            ...
            **/
            ...
            URL_GET_REMINDERS_SENT : 'http://getsir.mx/payme/ClientPaymeWebService.php?methodName=getRemindersSentByUserId&callback=JSON_CALLBACK&userid=',
            URL_SET_REINDERS_AS_READ :' http://getsir.mx/payme/ClientPaymeWebService.php?methodName=setReminderAsRead&callback=JSON_CALLBACK&idreminders=',
            //LOCAL STORAGE
